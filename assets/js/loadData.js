...
function setRecomended() {
    let data = [
        {a: 'New Delhi', b: 'Red Fort New Delhi', c: 'India', d: '5.0', e: 'Exceptional 2', h: 'assets/images/recommended/offers01.jpeg'},
        {a: 'London', b: 'London Bridge River Thames', c: 'United Kingdom', d: '5.0', e: 'Exceptional 3', h: 'assets/images/recommended/offers02.jpeg'},
        {a: 'Sydney', b: 'Opera House Sydney', c: 'Australia', d: '5.0', e: 'Exceptional 4',  h: 'assets/images/recommended/offers03.jpeg'},
        {a: 'New York', b: 'Statue Of Liberty New York ', c: 'United States of America', d: '5.0', e: 'Exceptional 5', h: 'assets/images/recommended/offers04.jpeg'}
    ];
    let content = '';
    data.map(el => {
...
function setTestimonials() {
    let data = [
        {a: 'New Delhi - Toronto flight', b: `"My Mom reached safely ..I really appreciate for taking care of everything.Initially I was much hesitant to re book from trip beam because of earlier incidents, but now I would definitely do it again not only me I would recommend my friends also."`, c: 'assets/images/customer/avatar01.png', d: 'Payal Agarwal'},
        {a: 'Sydney - New Delhi flight', b: `This is my second time I am booking with Tripbeam. My first trip was completely hassle free and I expect the same this time. As far booking goes Garima Jain was outstanding; very patient and was paying full attention to what our requirements were."`, c: 'assets/images/customer/avatar02.png', d: 'Ishaan Khatri'},
        {a: 'New Delhi - Hyderabad fight', b: `Very patient and excellent customer service by Pawan. Worked with couple of other travel agents, but got the lowest fare only with Tripbeam. Was provided with different routes of flight connectivity and fare options to select the best... Really appreciate TripBeam's customer service.`, c: 'assets/images/customer/avatar03.png', d: 'Inaya Ahuja'},
        {a: 'Amritsar - London fight', b: `"Awesome Support!!!I am saving his email for future reservations and highly recommend using his services. I asked him to hold my booking for a day, the next day asked him to completely change my tickets and he did not even miss a beat and got what I wanted. Thank You.`, c: 'assets/images/customer/avatar03.png', d: 'Kanan Anand'},
        {a: 'Mumbai - New York fight', b: `Customer service is very good of this company and they are very friendly and reasonable in answering all sorts of questions. Highly efficient in providing customer needs. Good job guys."`, c: 'assets/images/customer/avatar03.png', d: 'Amar Laghari'},
        {a: 'London - New Delhi fight', b: `I worked with Rahul Arora to book my tickets to India from USA. She did great job finding me itinerary which best suited for my custom needs :) . i dont know whether i have ever received such custom itinerary for my travel, so thank you for your help Rahul.`, c: 'assets/images/customer/avatar03.png', d: 'Dhruv Patel'},
    ];
